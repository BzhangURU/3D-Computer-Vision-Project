...
display('Please point out the location of point(x=0,y=0,z=150)');
[u_3,v_3]=ginput(1);
text(u_3,v_3,'**');
...
%The above is to calculate   x and  y   (z is not accurate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%The below is to calculate   y and  z   
...
x_2=(   -(m_matrix(4)-u_3*m_matrix(12))*(m_matrix(6)-v_3*m_matrix(10))+(m_matrix(8)-v_3*m_matrix(12))*(m_matrix(2)-u_3*m_matrix(10))-z_2*((m_matrix(3)-u_3*m_matrix(11))*(m_matrix(6)-v_3*m_matrix(10))-(m_matrix(7)-v_3*m_matrix(11))*(m_matrix(2)-u_3*m_matrix(10)))    )/((m_matrix(1)-u_3*m_matrix(9))*(m_matrix(6)-v_3*m_matrix(10))-(m_matrix(5)-v_3*m_matrix(9))*(m_matrix(2)-u_3*m_matrix(10)));                    
y_2=(    (m_matrix(8)-v_3*m_matrix(12))*(m_matrix(1)-u_3*m_matrix(9))-(m_matrix(4)-u_3*m_matrix(12))*(m_matrix(5)-v_3*m_matrix(9))  -z_2*((m_matrix(3)-u_3*m_matrix(11))*(m_matrix(5)-v_3*m_matrix(9))-(m_matrix(7)-v_3*m_matrix(11))*(m_matrix(1)-u_3*m_matrix(9)))    )/(   (m_matrix(2)-u_3*m_matrix(10))*(m_matrix(5)-v_3*m_matrix(9))-(m_matrix(6)-v_3*m_matrix(10))*(m_matrix(1)-u_3*m_matrix(9))     );
...
for count_i=1:8
    ...
    if camera_location_y(count_i)<10% y, not z, because it has been changed
        true(count_i)=0;
    end
...
camera_real_location_y%has already been given value at first half part
camera_real_location_z=camera_location_y(2)
